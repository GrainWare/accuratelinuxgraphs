function checkLinux() {
  ...
  if (answer == "0") {
    document.getElementById("linux-answer").innerHTML =
      "try actually answering the question, enjoy 2 minutes of the free software song!";
...
function checkKernel() {
  ...
  if (answer == "0") {
    document.getElementById("kernel-answer").innerHTML =
      "try actually answering the question, enjoy 2 minutes of the free software song!";
    let audio = new Audio("files/free-software-song.ogg");
    audio.play();
    return false;
...
function checkAccuracy() {
  ...
  if (answer == "0") {
    document.getElementById("accuracy-answer").innerHTML =
      "try actually answering the question, enjoy 2 minutes of the free software song!";
    let audio = new Audio("files/free-software-song.ogg");
    audio.play();
    return false;
...
function getAnswers() {
  ...
  document.getElementById("answers").innerHTML =
    "You got " + correct + " out of 3 questions correct!";
}
